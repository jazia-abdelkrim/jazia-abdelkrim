...
Welcome to my corner of the digital universe! 🚀 I'm a **Fresh Woman Tech Maker & AI enthusiastic** with a passion for solving problems, building innovative solutions, and continuously learning in the ever-evolving world of technology.

---

## 🛠️ About Me
- 💻 **Tech Enthusiast**: I love diving deep into programming, designing applications, and exploring cutting-edge technologies.
- 🎓 **Lifelong Learner**: started with C language and trying to learn web dev, but now, immersed in learning Python.
...
- **Languages**: C, Python, Java // but a python lover 👀
